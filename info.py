...
PICS = (environ.get('PICS', 'https://graph.org/file/ffcc74ce91d1aec314d29-e4f4231259b132181b.jpg')).split()


# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5097048997').split()] # For Multiple Id Use One Space Between Each.
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001845557183 -1002166455150').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1001744123306') # give your force subscribe channel id here else leave it blank
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None

# This Channel Is For When User Request Any File Name With command or hashtag like - /request or #request
reqst_channel = environ.get('REQST_CHANNEL', '-1002175660086')
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://12:12@cluster0.pnervm2.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
DATABASE_NAME = environ.get('DATABASE_NAME', "f")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'f')

MULTIPLE_DATABASE = bool(environ.get('MULTIPLE_DATABASE', True)) # Set True or False

# If Multiple Database Is True Then Fill All Three Below Database Uri Else You Will Get Error.
O_DB_URI = environ.get('O_DB_URI', "mongodb+srv://1234:1234@cluster0.p9rwvay.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # This Db Is For Other Data Store
F_DB_URI = environ.get('F_DB_URI', "mongodb+srv://N:N@cluster0.nkur3kf.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # This Db Is For File Data Store
S_DB_URI = environ.get('S_DB_URI', "mongodb+srv://123:123@cluster0.swao368.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # This Db is for File Data Store When First Db Is Going To Be Full.
...
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/TechnicalBichu')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'ipopkarnbot') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/pirategamers')
...
VERIFY_SHORTLINK_API = environ.get('VERIFY_SHORTLINK_API', 'cc1b9bd7cb3eb653d991460a48c1395b89707ada')
VERIFY_TUTORIAL = environ.get('VERIFY_TUTORIAL', 'https://youtube.com/shorts/On8ccLtK24Q?si=Hd5iFg5rL16y4kF3')
